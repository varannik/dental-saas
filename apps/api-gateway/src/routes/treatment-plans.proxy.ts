...
export const treatmentPlansProxyRoute: FastifyPluginAsync = async (app): Promise<void> => {
  ...
  registerUpstreamProxyRoutes(app, ['/treatment-plans', '/treatment-plans/*'], proxyRequest);
};
